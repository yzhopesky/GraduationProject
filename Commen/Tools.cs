...
namespace Commen
{
        ...
        public class Utils
        {
            ...
            /// <summary>
            /// 判定分隔字符串每段字符串是否在另一字符串中存在（不区分大小写）
            /// </summary>
            /// <param name="str">长字符串</param>
            /// <param name="stringarray">被测试的分隔字符串</param>
            /// <param name="strsplit">分隔符</param>
            /// <returns>若分隔字符串stringarray某段字符串存在于str，返回true</returns>
            ...
            /// <returns></returns>
            /// ksf 2015年9月11日16:26:09
            /// 需要 枚举项上面加上属性 [Description("属性文本")]
            ...
            /// 获取枚举类型对应值的枚举名称
            /// </summary>
            /// <param name="stype">枚举类型（输入typeof(类型名称)）</param>
            /// <param name="en">枚举项</param>
            /// <returns></returns>
            /// ksf 2015年9月11日16:41:45
            public static string GetEnumName(Type stype, Enum en)
            {
                var retstr = Enum.GetName(stype, en);
                return retstr;
            }
